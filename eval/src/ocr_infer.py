...
支持两种后端：
  ...
  2) 纯本地 HuggingFace Transformers 推理（Qwen2.5-VL / Qwen3-VL 等）
...
# 方式二：本地 HuggingFace 推理
python ocr_infer.py \
    --image-folder ../benchmark \
    --output ./songpanda_pred.xlsx \
    --backend hf \
    --model-path /path/to/Qwen2.5-VL-7B-SongPanda
"""
...
# =========================================================================
# 后端：HuggingFace Transformers 本地推理
# =========================================================================
class HFBackend:
...
def parse_args():
    ...
    parser.add_argument('--model-path', default=None,
                        help='HF 本地推理时的模型路径或仓库名')
    parser.add_argument('--device', default='auto',
                        help='HF 推理时使用的 device_map')
